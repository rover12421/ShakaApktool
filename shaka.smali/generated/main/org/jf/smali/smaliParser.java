...
public class smaliParser extends Parser {
	...
	public final smaliParser.smali_file_return smali_file() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: implements_spec, super_spec, class_spec, method, source_spec, field
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					// AST REWRITE
					// elements: annotation, access_list, member_name, literal, nonvoid_type_descriptor
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: access_list, member_name, literal, nonvoid_type_descriptor
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final smaliParser.method_return method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: member_name, access_list, method_prototype, statements_and_directives
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.local_directive_return local_directive() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, NULL_LITERAL, name, signature, nonvoid_type_descriptor
	...
	public final smaliParser.insn_format22c_string_return insn_format22c_string() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: STRING_LITERAL, REGISTER, INSTRUCTION_FORMAT22c_STRING, REGISTER
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.insn_format35c_method_return insn_format35c_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: register_list, method_reference, INSTRUCTION_FORMAT35c_METHOD
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
